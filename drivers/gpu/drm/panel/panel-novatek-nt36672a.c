...
static const struct nt36672a_panel_cmd tianma_xiaomi_tulip_fhd_video_on_cmds_2[] = {
	{ .data = {0xB0, 0x01} },
	{ .data = {0x35, 0x00} },
	{ .data = {0x51, 0xFF} },
	{ .data = {0x53, 0x2C} },
...
static const struct nt36672a_panel_desc tianma_xiaomi_tulip_fhd_video_panel_desc = {
	...
	.on_cmds_2 = tianma_xiaomi_tulip_fhd_video_on_cmds_2,
	.num_on_cmds_2 = ARRAY_SIZE(tianma_xiaomi_tulip_fhd_video_on_cmds_2),
};
